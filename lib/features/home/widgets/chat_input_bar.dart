...
class _ChatInputBarState extends State<ChatInputBar>
  ...
  Widget _buildContextMenu(BuildContext context, EditableTextState state) {
    ...
    if (Platform.isIOS) {
      // Use the native iOS system context menu to avoid the iOS 16+ clipboard permission prompt.
      // Custom Flutter context menus triggering programmatic paste cause unauthorized paste warnings.
